...
int main(){ //funcao principal
			int a[9],i, b[9]; //declaracao dos arrays e do contador
			
			for(i=0; i<=8; ++i) { //for para escanear os 9 indices			
				scanf("%i", &a[i]); //scanf da matriz original
			}
			...
			b[8]=a[5]; //atribuicao diferente
			b[7]=a[6]; //atribuicao diferente
			b[6]=a[7]; //atribuicao diferente
			b[5]=a[8]; //atribuicao diferente
